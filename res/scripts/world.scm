...
;;; world.scm
;;;
;;; Uses cellular automata modelling to create interesting game maps.
;;;
...
(define flood-fill
  (lambda (mat2d target-color sub-color start-x start-y)
...
(define auto-mask-region
  (lambda (mat2d)
    (define result (flood-fill mat2d 1 5 0 0))
    result))
